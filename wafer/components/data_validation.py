...
class DataValidation:
    ...
    def validate_raw_files(self, expected_length_of_date_stamp: int, expected_length_of_time_stamp: int) -> None:
        """Validates the raw training files names by referencing a regular eperession composed in regard to the 
        MDM (Master Data Management) by performing checks for expected date and time stamps' length. And moves the
    ...
    def initiate(self) -> DataValidationArtifact:
        ...
        try:
            ...
            lg.info("Ultimatelty deleting `Bad Raw Data` dir..")
